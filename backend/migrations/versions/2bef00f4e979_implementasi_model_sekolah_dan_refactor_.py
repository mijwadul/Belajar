"""Implementasi model Sekolah dan refactor struktur model

Revision ID: 2bef00f4e979
Revises: 
Create Date: 2025-07-17 21:45:05.622906
...
def upgrade():
    ...
    sa.Column('nama_orang_tua', sa.String(length=150), nullable=True),
    sa.PrimaryKeyConstraint('id'),
